    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, height: "100%", padding: "45px 60px 45px 170px", display: "flex", flexDirection: "column", boxSizing: "border-box", overflow: "hidden" }}>
          ...
          {/* ─── PORTFOLIO GRID DECK ─── */}
          {isLoading ? (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "30px", flex: 1, overflowY: "auto" }}>
              {Array.from({ length: 6 }).map((_, i) => <BlueprintFolderSkeleton key={i} />)}
            </div>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", border: "2px dashed #c4b8a8", borderRadius: "16px", backgroundColor: "rgba(255,255,255,0.2)" }}>
              <p style={{ fontFamily: "'Caveat', cursive", fontSize: "24px", color: "#2d2416", opacity: 0.6 }}>No matching blueprints found on desk layout.</p>
            </div>
          ) : (
            <div 
              style={{ 
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      height: "215px", // FIXED: Changed minHeight to fixed height to anchor layout scale uniformly
                      boxSizing: "border-box",
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", gap: "8px" }}>
                        <h4 
                          style={{ 
                            ...
                            fontSize: "22px", // FIXED: Slightly dialed down header to optimize multi-line fit
                            fontWeight: 800, 
                            color: "#2d2416", 
                            lineHeight: 1.1, 
                            flex: 1,
                            // FIXED: Added multi-line CSS clamping framework to safeguard layout alignment
                            display: "-webkit-box",
                            WebkitLineClamp: 2,
                            WebkitBoxOrient: "vertical",
                            overflow: "hidden",
                            height: "48px", // FIXED: Fixed height preserves line space regardless of title length
                          }}
                        >
                          {card.title}
                        </h4>
